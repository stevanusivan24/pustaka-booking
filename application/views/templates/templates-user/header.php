...
<body>
 ...
 <button class="navbar-toggler" type="button" datatoggle="collapse" datatarget="#navbarNavAltMarkup" ariacontrols="navbarNavAltMarkup" aria-expanded="false" arialabel="Toggle navigation">
